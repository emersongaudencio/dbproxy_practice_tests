...
sysbench /usr/share/sysbench/oltp_read_write.lua --threads=4 --mysql-host=${VAR_HOST} --mysql-user=app_user --mysql-password=test123 --mysql-port=${VAR_PORT} --tables=100 --table-size=10000 prepare
