...
$mysqli->query("CREATE TABLE IF NOT EXISTS `dbtest1`.`joinit` (
...
$mysqli->query("INSERT INTO dbtest1.joinit VALUES (NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )));");
$mysqli->query("INSERT INTO dbtest1.joinit SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest1.joinit;");
$mysqli->query("INSERT INTO dbtest1.joinit SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest1.joinit;");
$mysqli->query("INSERT INTO dbtest1.joinit SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest1.joinit;");
$mysqli->query("INSERT INTO dbtest1.joinit SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest1.joinit;");
$mysqli->query("INSERT INTO dbtest1.joinit SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest1.joinit;");
...
echo date('Y-m-d H:i:s') . " Starting to RUN the test on dbtest1.joinit\n";
