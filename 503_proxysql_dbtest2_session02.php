...
$mysqli = new mysqli('127.0.0.1', 'app_user', 'test123', 'dbtest2', 3306);
...
/* Setup */
echo date('Y-m-d H:i:s') . " Starting to SETUP the dbtest2\n";
$mysqli->query("DROP TABLE IF EXISTS joinit1");
$mysqli->query("CREATE TABLE IF NOT EXISTS `dbtest2`.`joinit1` (
...
$mysqli->query("INSERT INTO dbtest2.joinit1 VALUES (NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )));");
$mysqli->query("INSERT INTO dbtest2.joinit1 SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest2.joinit1;");
$mysqli->query("INSERT INTO dbtest2.joinit1 SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest2.joinit1;");
$mysqli->query("INSERT INTO dbtest2.joinit1 SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest2.joinit1;");
$mysqli->query("INSERT INTO dbtest2.joinit1 SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest2.joinit1;");
$mysqli->query("INSERT INTO dbtest2.joinit1 SELECT NULL, uuid(), time('$date1'),  (FLOOR( 1 + RAND( ) *60 )) FROM dbtest2.joinit1;");
...
echo date('Y-m-d H:i:s') . " Starting to RUN the test on table dbtest2.joinit1\n";
